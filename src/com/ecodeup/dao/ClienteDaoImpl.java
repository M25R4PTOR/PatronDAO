...
public class ClienteDaoImpl implements IClienteDao {
	...
	public void actualizarCliente(Cliente cliente) {
		...
		System.out.println("Cliente con id: " + cliente.getId() + " actualizado satisfactriamente");
	}
	...
	public void eliminarCliente(Cliente cliente) {
		...
		System.out.println("Cliente con id: " + cliente.getId() + " eliminado satisfactriamente");
	}
}
